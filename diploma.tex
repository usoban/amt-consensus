...
\hyphenation{ko-mple-me-nta-rne-ga}
\hyphenation{ta-kso-no-mski-mi}
\hyphenation{izho-dnih}
\hyphenation{pri-me-rja-nje}
\hyphenation{mo-du-la}
\hyphenation{imple-me-nti-ra}
\hyphenation{ne-ko-mpa-ti-bi-lno-sti}
...
Rezultati diplomskega dela so intelektualna lastnina avtorja. Za
...
ter mentorja%
\footnote{V dogovoru z mentorjem lahko kandidat diplomsko delo
s pripadajočo izvorno kodo izda tudi pod katero izmed alternativnih licenc,
ki ponuja določen del pravic vsem: npr. Creative Commons, GNU GPL. V tem
primeru na to mesto vstavite opis licence, na primer
tekst~\cite{licence}.}.}

% TODO: meni je načeloma vseeno, za kaj se odločiš.
% Najbrž je smiselno, ker del Biopythona, da daš isto licenco kot to ima
% Biopython?
...
% TODO: najbrz si to ti napisal in ni iz predloge
Družini.
...
značilnosti organizmov. Danes jih gradimo programsko, z uporabo različnih
metod in na podlagi različnih virov podatkov, npr., primerjava DNA ali RNA.
...
z uspešnostmi metod za gradnjo striktnega, večinskega in Adamovega
...
% TODO: še ti preveri. Prav vseh rezultatov ne bi pisal v
% povzetek. Le tiste najbolj pomembne.
% Ustrezno popravi še angleško verzijo.
...
units. First phylogenetic trees had been drawn by hand on the basis of
morphological properties of organisms. Today, they are constructed
...
hypotheses of evolution are often contradictory, and need to be resolved by
...
method with methods for strict, majority and Adam consensus trees on a
...
% TODO: preveri, ce so vse reference na vrstice (tudi drugje) pravilne
...
% TODO: spodnji naslov sem najbrž jaz zamočil v eni od prejšnjih revizij.
% Ker gre za dve meri, je prav, da sta obe omenjeni v naslovu.
% Preveri, če je tako ok.
