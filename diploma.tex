...
kjer je razmerje vnaprej znano)~\cite{phy}, raziskovalci po navadi uporabijo eno 
...
čemer je treba poudariti, da je vrstni red posameznih znakov v binarnem nizu 
...
Če binarne nize vseh kladov drevesa zberemo v množico (\ref{eq:3}), 
...
Kodiranje zdaj lahko izvedemo nad vsemi drevesi vhodne množice $T$, pri čemer je 
...
Če velja enačba \ref{eq:9}, potem za matriko $M'$ obstaja filogenetsko 
...
vsebovanosti enega bitnega niza v drugem ter preverjanje kompatibilnosti 
dveh binarnih nizov. 
...
Zdaj imamo pripravljeno vse, da lahko v vrsticah 20-24 s pomočjo prej ustvarjenih 
...
Rezultati konsenznih dreves s slike \ref{img-eval-result-2} glede na vhodna 
...
Tretja vhodna množica dreves s slike \ref{table-eval-3} je sestavljena tako, 
